...
따뜻한 차를 마시며 마음을 정리하는 모습.
근처에는 건강·웰니스 정책을 상징하는 작은 아이콘
(심박수, 식단, 물병, 햇살, 건강 문서, 체크리스트)이
가볍게 떠 있는 구성.
전체 색감은 베이지·연노랑·은색의 파스텔톤.
...
주변에 건강 정책 아이콘(운동화, 심박 그래프, 스톱워치 아이콘)이 떠있음.
...
작은 하트, 노트, 이어폰, 식물 아이콘이 떠 있으며
라이프케어·힐링 정책 정보를 직관적으로 암시.
은은한 연노랑·베이지 색감.
...
breathing and relaxing in a calm space.
Small icons float around: heart rate symbol, meal checklist,
water bottle, sunshine icon, wellness documents.
Soft pastel palette in beige, pale yellow, and silver.
...
Tiny trees and street elements drawn in Sempé’s charming proportions.
Floating health icons: sneakers, heart-rate graph, stopwatch.
...
Small icons such as hearts, notes, headphones, and leaves
represent emotional wellness policies.
Pastel beige and soft yellow tones.
Minimal, airy, gentle, and soothing.